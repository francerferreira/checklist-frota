...
ROLE_PAGES = {
    "admin": {"dashboard", "operations_center", "nc", "productivity", "reports", "checklist_history", "equipment", "checklist_items", "inspection_templates", "materials", "washes", "activities", "maintenance", "availability", "emergencies", "pcm", "resources", "purchases", "supply_library", "users", "cloud_backup", "audit_logs", "admin_rules"},
    "gestor": {"dashboard", "operations_center", "nc", "productivity", "reports", "checklist_history", "equipment", "checklist_items", "inspection_templates", "materials", "washes", "activities", "maintenance", "availability", "emergencies", "pcm", "resources", "purchases", "supply_library", "admin_rules"},
