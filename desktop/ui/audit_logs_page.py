...
class AuditLogsPage(QFrame):
    def __init__(self, api_client, parent=None):
        ...
        self.entity_filter.addItem("Inspeções", "ACTIVITY")
        self.entity_filter.addItem("Itens de Inspeção", "ACTIVITY_ITEM")
        ...
        self.entity_filter.addItem("Configuração administrativa", "SYSTEM_SETTING")
        self.entity_filter.addItem("Relatório de manutenção", "MAINTENANCE_REPORT")
        self.entity_filter.addItem("Ordem de serviço", "MAINTENANCE_WORK_ORDER")
