...
class ActivityDetailDialog(QDialog):
    def __init__(self, api_client, activity_id: int, parent=None):
        ...
        export_csv.setProperty("variant", "success")
        ...
        material_button.setProperty("variant", "primary")
