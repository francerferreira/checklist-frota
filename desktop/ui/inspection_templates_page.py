...
class InspectionTemplateDialog(QDialog):
    def __init__(self, families: list[dict], template: dict | None = None, parent=None):
        ...
        form.addRow("Módulo", self.family)
...
class InspectionTemplatesPage(QFrame):
    ...
    def __init__(self, api_client, parent=None):
        ...
        subtitle = QLabel("Crie modelos por módulo. Versões publicadas ficam congeladas para preservar o histórico.")
        ...
        self.table.setHorizontalHeaderLabels(["Módulo", "Código", "Nome", "Versão", "Situação", "Itens", "Publicada em"])
