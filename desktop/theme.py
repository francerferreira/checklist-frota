...
QFrame#Sidebar,
QFrame#ContentSurface, QWidget#ContentSurface,
QFrame#PanelCard, QWidget#PanelCard,
QFrame#ImagePanel, QWidget#ImagePanel,
QFrame#HeaderCard, QWidget#HeaderCard,
QFrame#FilterBar, QWidget#FilterBar,
QFrame#TableCard, QWidget#TableCard,
QFrame#TopNavStrip,
QFrame#TopNavGridHost,
QFrame#TopBar,
QFrame#TopBarActionCluster,
