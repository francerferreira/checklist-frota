...
O portable foi configurado sem compressão `UPX`, sem otimização de bytecode e com empacotamento mais completo, para reduzir falso positivo de antivírus corporativo durante a execução.
