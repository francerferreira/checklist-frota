...
function loadOfflineReferenceData() {
    const cachedVehicles = JSON.parse(localStorage.getItem(OFFLINE_VEHICLES_KEY) || "null");
    const cachedCatalog = JSON.parse(localStorage.getItem(OFFLINE_CATALOG_KEY) || "null");
