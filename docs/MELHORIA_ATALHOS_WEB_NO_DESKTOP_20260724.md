# Atalhos Web no Desktop

O menu `Painéis Web` do Desktop possui dois atalhos:

- `Abrir Web Mobile` abre `http://127.0.0.1:5500/`.
- `Abrir Dashboard TV` abre `http://127.0.0.1:5500/dashboard-manutencao/tv/`.
